...
<div id="wrapper">
	...
	<div class="left side-menu">
		<div class="sidebar-inner slimscrollleft">
			...
			<div class="user-box">
				<div class="user-img">
					<img src="<?php echo base_url(); ?>assets/images/users/avatar-1.jpg" alt="user-img" title="Admin"
				...
				<ul>
					...
					<li class="has_sub">
						...
						<ul class="list-unstyled">
							...
							<!--							<li>-->
							<!--								<a href="-->
							<?php //echo api_url('payment/method'); ?><!--">Methods</a>-->
							<!--							</li>-->
						</ul>
					</li>
					...
					<li class="has_sub">
						...
						<ul class="list-unstyled">
							...
							<!--                                <li>-->
							<!--                                    <a href="-->
							<?php //echo api_url('vehicle/type'); ?><!--">Vehicle Type</a>-->
							<!--                                </li>-->
						</ul>
					</li>
					...
					<li class="has_sub">
						...
						<ul class="list-unstyled">
							...
							<!--                                <li>-->
							<!--                                    <a href="-->
							<?php //echo api_url('quotes/reqs'); ?><!--">Quote Reqs.</a>-->
							<!--                                </li>-->
						</ul>
					</li>
