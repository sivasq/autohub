<?php $this->load->view('includes/headers/admin-header'); ?>
    <script src="<?php echo base_url(); ?>assets/constants/vehicle-type.constants.js"></script>
    <div class="row">
        <div class="col-sm-12">
            <div class="panel">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Add vehicle Type</h4>

                                <form class="form-horizontal"
                                      action="<?php echo api_url("vehicle/type/create"); ?>"
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-sm-4 control-label">Vehicle Type *</label>
                                        <div class="col-sm-7">
