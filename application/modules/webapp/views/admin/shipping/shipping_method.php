            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Add Shipping Method</h4>

                                <form class="form-horizontal"
                                      action="<?php echo api_url("shipping-method/create"); ?>"
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-sm-4 control-label">Shipping Method *</label>
                                        <div class="col-sm-7">
