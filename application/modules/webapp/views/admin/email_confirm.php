    ...
    <div class="wrapper-page">
	    ...
	    <div class="m-t-40 card-box">
		    ...
		    <div class="panel-body text-center">
			    ...
			    <p class="text-muted font-13 m-t-20"> A email has been send to <b><?php echo $email; ?></b>. Please check for an email from company and click on the included link to reset your password. </p>
		    </div>
	    </div>
        <!-- end card-box-->
	    ...
	    <div class="row">
		    <div class="col-sm-12 text-center">
			    <p class="text-muted">Return to <a href="<?php echo base_url('index.php/admin/auth'); ?>" class="text-primary m-l-5"><b>Sign In</b></a></p>
		    </div>
	    </div>
    </div>
    <!-- end wrapper page -->
