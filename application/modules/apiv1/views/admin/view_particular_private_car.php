                                       ...
                                       <div class="row" style="border:1px solid #f1f1f1; border-radius:5px;">
                                          <div class="col-xs-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-lg-12 text-center">
                                              <h3><span style="font-size:15px; font-weight:bold; text-transform:uppercase;"><u>User Details</u></span></h3>
                                            </div>                                           
                                              ...
                                              <div class="col-lg-12 col-md-12">             
                                                <div class="row">
                                                  <div class="form-group col-lg-6 col-md-6">
                                                    <span>Name: </span>
                                                    <?php echo $private_detail->first_name." ".$private_detail->last_name; ?> <br>
                                                    <span>Email:  </span>
                                                    <?php echo $private_detail->email; ?> <br>
                                                    <span>Phone: </span>
                                                    <?php echo $private_detail->phone; ?> <br>
                                                   
                                                  </div>

                                                  <div class="form-group col-lg-6 col-md-6">
                                                    <span>Country: </span>
                                                    <?php echo $private_detail->country; ?> <br>
                                                    <span>Refferal Code: </span>
                                                    <?php echo $private_detail->ref_code; ?> <br>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 text-center">
                                              ...
                                              <div class="col-lg-12 col-md-12">             
                                                <div class="row">
                                                  <div class="form-group col-lg-6 col-md-6">
                                                    <span>Car Type: </span>
                                                    <?php echo $private_detail->car_type; ?> <br>
                                                    <span>Car VIN:  </span>
                                                    <?php echo $private_detail->car_vin; ?> <br>
                                                    <span>Car Status: </span>
                                                    <?php echo $private_detail->car_status; ?> <br>
                                                   
                                                  </div>

                                                   <div class="form-group col-lg-6 col-md-6">
                                                    <span>Car Year/Model: </span>
                                                    <?php echo $private_detail->car_year." ".$private_detail->car_model; ?> <br>
                                                    <span>Car Make: </span>
                                                    <?php echo $private_detail->car_make; ?> <br>
                                                    <span>Car Trim: </span>
                                                    <?php echo $private_detail->car_trim; ?> <br>
                                                    <span>Car Mileage: </span>
                                                    <?php echo $private_detail->car_mileage; ?> <br>
                                                  </div>
                                                </div>
                                              </div>
                                              </div>
                                        ...
                                        <div class="row" style="border:1px solid #f1f1f1; border-radius:5px;">
                                          <div class="col-xs-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-md-offset-4">             
                                                <div class="row">
                                                    <img class="img-responsive" style="width: 300px; height: 150px;" src="<?php echo $private_detail->img_url;?>" >
                                                </div>
                                            </div>
                                          </div>
