...
<script type="text/javascript"
        src="<?php echo base_url(); ?>assets/plugins/jquery-quicksearch/jquery.quicksearch.js"></script>
...
<script src="<?php echo base_url(); ?>assets/plugins/bootstrap-inputmask/bootstrap-inputmask.min.js"
        type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>assets/plugins/bootstrap-inputmask/bootstrap-inputmask.min.js"
        type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/plugins/select2/dist/js/select2.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>assets/pages/datatables.product.editable.init.js"></script>
<script src="<?php echo base_url(); ?>assets/pages/datatables.editable.init.js"></script>
<script src="<?php echo base_url(); ?>assets/pages/datatables.editable.advanced.init.js"></script>


<script src="<?php echo base_url(); ?>assets/pages/datatables.init.js"></script>
<script src="<?php echo base_url(); ?>assets/ajax/helper.js"></script>
...
<script>
	jQuery(document).ready(function () {
		...
		$('#my_multi_select3').multiSelect({
			selectableHeader: "<input type='text' class='form-control search-input' autocomplete='on' placeholder='search...'>",
			selectionHeader: "<input type='text' class='form-control search-input' autocomplete='on' placeholder='search...'>",
