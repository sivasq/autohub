...
//        );
    ...
    public function condition_create()
    {
        ...
        $this->create(SELF::CONDITION_URL, $id, $rules, $this->postConditionData(), $this->tableConditions, 'pco_id');
    }
    ...
    public function type_create()
    {
        ...
        $this->create(SELF::TYPE_URL, $id, $rules, $this->postTypeData(), $this->tableTypes, 'pty_id');
    }
