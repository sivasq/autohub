...
class Vehicle_model extends Generic_model
{
    ...
    {
        $this->db->select($this->tbl_vehicle . ".*, " . $this->prfx_vehicle_type . "name as vehicleType, " . $this->prfx_business_type . "name as businessType, " . $this->prefix_vehicle_company . "companyName , " . $this->prefix_vehicle_driver . "firstName as driverName");
