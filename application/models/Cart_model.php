...
class Cart_model extends Generic_model
{
	...
	{
		$this->db->select("crt_id, crt_userId, crt_mileage, crt_comment, " . $this->Product_model->get_product_select_items() . "," . $this->Vehicle_model->get_vehicle_select_items() . "," . $this->Productcondition_model->get_product_condition_select_items());
