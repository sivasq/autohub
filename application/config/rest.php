...
// $config['auth_override_class_method']['api']['add_car_details'] = 'none';
// $config['auth_override_class_method']['api']['create_business_owner'] = 'none';
// $config['auth_override_class_method']['api']['owner_login_auth'] = 'none';
// $config['auth_override_class_method']['api']['staff_login_auth'] = 'none';
// $config['auth_override_class_method']['api']['test'] = 'none';

$config['auth_override_class_method']['auth']['user_registration'] = 'none';
$config['auth_override_class_method']['auth']['user_login_auth'] = 'none';
$config['auth_override_class_method']['auth']['send_otp'] = 'none';
$config['auth_override_class_method']['auth']['otp_verify'] = 'none';
$config['auth_override_class_method']['auth']['email_validate'] = 'none';
$config['auth_override_class_method']['home']['img_process'] = 'none';
$config['auth_override_class_method']['home']['test_img'] = 'none';
