...
!function ($) {
    ...
    MorrisCharts.prototype.createLineChart = function (element, data, xkey, ykeys, labels, opacity, Pfillcolor, Pstockcolor, lineColors) {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ['Passed', 'Failed'], ['#ffffff'], ['#999999'], ['#5b69bc', "#35b8e0"]);
            ...
            var $barData = [
                ...
                {y: '2016', a: 100, b: 90, c: 40},
                {y: '2017', a: 75, b: 65, c: 20},
                {y: '2018', a: 50, b: 40, c: 50},
            ];
